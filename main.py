...
if __name__ == "__main__":
    for dim in [2,5,10]:
        for seed in range(10):
            ...
            seed = seed
            alg_names = ["CMA-ES, DE"]
            #bench_path = f"./results_Benchmark/dim{dim}_seed{seed}.csv"
            bench_path = f"./results_Benchmark_trace/dim{dim}_seed{seed}_all.csv"
    ...
    #%%
    # plot_grid(es, population="random")
    # plot_grid(es, population="novelty")
    #genome, features, opt_alphas, opt_means, G, monoG, decoG  = es.cell_to_instance(cell=(10, 10), population="novelty")
    #plot_scatter(es, store_key="NSall", s=10, alpha=0.4, scale=None)
